...
const testimonials = [
  ...
  },
  {
    ...
    name: "Michael Chen",
    review:
      "As a busy professional, SEA Catering saves me so much time while keeping me healthy.",
    rating: 4,
  },
  {
    id: 3,
    name: "David Wilson",
    review:
      "The variety and quality of meals is outstanding. Highly recommend!",
    rating: 5,
  },
];
    ...
    <div className="home-page">
      <section className="hero">
        ...
        >
          ...
          <p>
            Customizable healthy meal service with delivery all across
            Indonesia. Enjoy chef-prepared meals tailored to your dietary needs.
          </p>
          <button className="cta-button" onClick={change}>
            Explore Our Menu
          </button>
        </motion.div>
        <motion.div
          ...
          {[
            {
              ...
              description:
                "Tailor your meals to your dietary preferences and restrictions.",
            },
            {
            ...
            },
            {
              ...
              description:
                "Choose your meals, delivery days, and subscription length.",
            },
          ].map((feature, index) => (
            <motion.div
              key={index}
